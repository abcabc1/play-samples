...
public enum ExceptionEnum {
    ...
    WRONG_TYPE_PARAM_IN_JSON_REQUEST("503", "Expect {0} param but found {1} in json request"),
    DICT_EN_FAILURE("504", "Found {0} En dict failure"),
    DICT_CN_FAILURE("505", "Found {0} Cn dict failure"),
    RESET_TREE_CHILD_NODE_FAILURE_1("505", "Can not relocate child with NULL parent"),
    RESET_TREE_CHILD_NODE_FAILURE_2("505", "Missing parent's level or seq when relocate child"),
    RESET_TREE_CHILD_NODE_FAILURE_3("505", "No need handle child if parent doesn't shift position"),
